        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-10">
                        <select name="pid" class="form-control">
                            ...
                            <foreach from="$category" value="$d">
                                <option value="{{$d['cid']}}" {{$d[
                                '_disabled']}} {{$d['_selected']}}>{{$d['_catname']}}</option>
                            </foreach>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="catname" value="{{$model['catname']}}" class="form-control" id=""
                               placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">封面栏目</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <if value="$model['ishome']==1">
                                <input type="radio" name="ishome" value="1" checked="checked"> 是
                                <else/>
                                <input type="radio" name="ishome" value="1"> 是
                            </if>

                        </label>
                        <label class="radio-inline">
                            <if value="$model['ishome']==0 || !$model['ishime']">
                                <input type="radio" name="ishome" value="0" checked="checked"> 否
                                <else/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="linkurl" value="{{$model['linkurl']}}" class="form-control" id=""
                               placeholder="">
                    </div>
                </div>
                <div class="form-group">
