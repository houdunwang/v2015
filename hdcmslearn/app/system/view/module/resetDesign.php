...
<block name="content">
	<div class="clearfix">
        ...
        <form class="form-horizontal" id="form" @submit.prevent="submit" v-cloak>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <div class="input-group" style="margin-left:-15px;margin-bottom:10px">
                            <span class="input-group-addon">操作名称</span>
                            <input class="form-control" v-model="field.web.entry.title" placeholder="请输入中文操作名称">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <div class="input-group" style="margin-left:-15px;margin-bottom:10px">
