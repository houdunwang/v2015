...
<!-- 百度流量统计结束 -->
<link rel="stylesheet" href="{{ARTICLE_URL}}/css/footer.css?version={{HDCMS_VERSION}}" />
<div id="footer">
	<div id="footer_box">
		<div class="logo">
		...
		<div class="msg">
            ...
            <p>
                本项目基于 <a href="http://www.hdcms.com" style="color:#57b382" target="_blank">HDCMS</a>
                底层使用 <a href="http://www.hdphp.com"  style="color:#57b382" target="_blank">HDPHP</a> 构建</p>
		</div>
		<div class="footer_link">
			<ul>
				<li>
					<a href="http://www.houdunwang.com/article11-51-42-3.html">关于我们</a>
				</li>
				<li>
				...
				<li>
					<a href="http://www.houdunwang.com/article11-52-42-3.html">招贤纳士</a>
				</li>
				<li>
					<a href="http://tb.53kf.com/webCompany.php?arg=9003998&style=1">在线客服</a>
				</li>
			</ul>
		</div>
		...
		<div class="followus">
			<a href="" class="followus_weixin">
				<div class="weixin_box">
					<img src="template/block/footer/hdcode.png" alt="" />
				</div>
			</a>
			<a href="http://weibo.com/houdunwang" class="followus_sina"></a>
			<a href="" class="followus_qq"></a>
		</div>
	</div>
</div>