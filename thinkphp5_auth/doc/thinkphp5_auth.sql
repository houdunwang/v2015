/*
 ...
 Source Database       : thinkphp5_auth

 Target Server Type    : MySQL
 Target Server Version : 50635
 File Encoding         : utf-8

 Date: 11/01/2017 13:48:30 PM
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_admin` VALUES ('2', 'admin', 'h3vPU8JGuF3VS/uxIpjRSw=='), ('4', 'wubin', 'h3vPU8JGuF3VS/uxIpjRSw==');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_auth_group` VALUES ('3', '超级管理员', '1', '1,6,5,7,8,9'), ('4', '数据观测员', '1', '1,7,9');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_auth_group_access` VALUES ('2', '3'), ('4', '4');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_auth_rule` VALUES ('1', 'admin/Category/index', '栏目列表', '0', '1', '1', '', '栏目管理'), ('6', 'admin/Category/edit', '栏目编辑', '1', '1', '1', '', '栏目管理'), ('7', 'admin/Entry/index', '欢迎页面', '0', '1', '1', '', '后台首页'), ('5', 'admin/Category/store', '栏目添加', '1', '1', '1', '', '栏目管理'), ('8', 'admin/Entry/pass', '修改密码', '7', '1', '1', '', '后台首页'), ('9', 'admin/Entry/out', '后台退出', '7', '1', '1', '', '后台首页');
COMMIT;
