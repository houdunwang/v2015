<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/group/store.html";i:1509257875;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('index'); ?>">用户组添加</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li ><a href="<?php echo url('index'); ?>">用户组列表</a></li>
    <li class="active"><a href="<?php echo url('store'); ?>">用户组添加</a></li>
</ul>
    			...
    			<div class="panel panel-default">
    				  ...
    				  <div class="panel-body">
    						<div class="checkbox">
    							...
    							<label>
    								<input type="checkbox" name="rules[]" value="<?php echo $d['id']; ?>"><?php echo $d['title']; ?>
    							</label>
