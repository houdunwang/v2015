<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/rules/edit.html";i:1509085680;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('index'); ?>">规则列表</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li ><a href="<?php echo url('index'); ?>">规则列表</a></li>
    <li class="active"><a href="<?php echo url('store'); ?>">规则添加</a></li>
</ul>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				<label for="" class="col-sm-2 control-label">规则中文名称</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="title" value="<?php echo $oldData['title']; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="" class="col-sm-2 control-label">规则标识</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="name" value="<?php echo $oldData['name']; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="" class="col-sm-2 control-label">父规则</label>
				<div class="col-sm-10">
					<select name="pid" id="inputID" class="form-control">
						...
						<option value="<?php echo $vo['id']; ?>" <?php if($oldData['pid']==$vo['id']): ?>selected<?php endif; ?>>  <?php echo $vo['_title']; ?>  </option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
			<div class="form-group">
				<label for="" class="col-sm-2 control-label">导航</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="nav" value="<?php echo $oldData['nav']; ?>">
				</div>
			</div>
		</div>
	</div>
	<input type="text" hidden name="id" value="<?php echo input('param.id'); ?>">
