<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/admin/setauth.html";i:1509438620;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('setAuth'); ?>">设置权限</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li ><a href="<?php echo url('index'); ?>">用户列表</a></li>
    <li ><a href="<?php echo url('store'); ?>">用户添加</a></li>
    <li class="active"s><a href="<?php echo url('setAuth'); ?>">设置权限</a></li>
</ul>
<form action="" method="POST" class="form-horizontal" role="form">
    <div class="panel panel-default">
    	  <div class="panel-heading">
    			<h3 class="panel-title">给管理员【<?php echo $adminInfo['admin_username']; ?>】设置权限</h3>
    	  </div>
    	  <div class="panel-body">
			<div class="checkbox">
				<?php if(is_array($groupData) || $groupData instanceof \think\Collection || $groupData instanceof \think\Paginator): if( count($groupData)==0 ) : echo "" ;else: foreach($groupData as $key=>$vo): ?>
				<label>
					<input type="checkbox" <?php if(in_array($vo['id'],$accessData)): ?>checked<?php endif; ?> name="group_id[]" value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?>
				</label>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		  </div>
    </div>
	<input type="text" hidden name="admin_id" value="<?php echo input('param.admin_id'); ?>">
