<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/rules/store.html";i:1509061591;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509010179;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select name="pid" id="inputID" class="form-control">
						...
						<option value="<?php echo $vo['id']; ?>">  <?php echo $vo['_title']; ?>  </option>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="nav">
				</div>
			</div>
		</div>
	</div>
