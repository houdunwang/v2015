<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/admin/index.html";i:1509434938;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('index'); ?>">用户列表</a>
    </li>
</ol>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('edit',['admin_id'=>$vo['admin_id']]); ?>">编辑</a></li>
                                    <li><a href="<?php echo url('setAuth',['admin_id'=>$vo['admin_id']]); ?>">分配权限</a></li>
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $vo['admin_id']; ?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
					</tr>
