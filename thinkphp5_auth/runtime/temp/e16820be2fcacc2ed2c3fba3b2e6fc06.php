<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/admin/edit.html";i:1509005723;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('edit'); ?>">用户编辑</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li ><a href="<?php echo url('index'); ?>">用户列表</a></li>
    <li class="active"s><a href="">用户编辑</a></li>
</ul>
    ...
    <div class="panel panel-default">
    	  ...
    	  <div class="panel-body">
			  <div class="form-group">
				  ...
				  <div class="col-sm-10">
					  <input type="text" class="form-control" name="admin_username" value="<?php echo $userInfo['admin_username']; ?>">
				  </div>
			  </div>
			  <div class="form-group">
				  <label for="" class="col-sm-2 control-label">管理员密码</label>
				  <div class="col-sm-10">
					  <input type="text" class="form-control" name="admin_password" value="<?php echo $userInfo['admin_password']; ?>">
				  </div>
			  </div>
		  </div>
    </div>
