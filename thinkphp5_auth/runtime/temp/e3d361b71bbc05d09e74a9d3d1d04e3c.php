<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/group/index.html";i:1509261509;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="<?php echo url('index'); ?>">用户组列表</a></li>
    <li><a href="<?php echo url('store'); ?>">用户组添加</a></li>
</ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
					</tr>
