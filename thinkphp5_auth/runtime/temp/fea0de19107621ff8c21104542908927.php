<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/group/edit.html";i:1509261129;s:78:"/Users/wubin/Desktop/thinkphp5_auth/public/../application/admin/view/base.html";i:1509254501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    	  ...
    	  <div class="panel-body">
              <?php if(is_array($rules) || $rules instanceof \think\Collection || $rules instanceof \think\Paginator): if( count($rules)==0 ) : echo "" ;else: foreach($rules as $k=>$vo): ?>
    			<div class="panel panel-default">
    				  ...
    				  <div class="panel-body">
    						<div class="checkbox">
                                <?php if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): if( count($vo)==0 ) : echo "" ;else: foreach($vo as $key=>$d): ?>
    							<label>
    								<input type="checkbox" name="rules[]" value="<?php echo $d['id']; ?>" <?php if(in_array($d['id'],$field['rules'])): ?>checked<?php endif; ?> ><?php echo $d['title']; ?>
    							</label>
