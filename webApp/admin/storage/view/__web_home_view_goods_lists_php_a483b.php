...
<div class="row">
	...
	<ul class="nav nav-pills" role="tablist">
		...
		<li><a href="<?php echo u('post')?>">新增菜品</a></li>
	</ul>
	<br>
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<table class="table table-hover">
				...
				<?php foreach ((array)$data as $d){?>
					<tr>
						...
						<td>
							<img src="<?php echo $d['thumb']?>" style="width:80px;¬">
						</td>
						<td><?php echo $d['price']?>元</td>
						<td>
							<div class="btn-group">
								<a href="<?php echo u('post',['id'=>$d['id']])?>" class="btn btn-default">编辑</a>
								<a href="<?php echo u('del',['id'=>$d['id']])?>" class="btn btn-default">删除</a>
							</div>
						</td>
					</tr>
				<?php }?>
