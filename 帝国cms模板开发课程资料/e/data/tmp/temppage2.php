...
?>
    ...
    <div class="row container-kamn">  
        <img src="[!--news.url--]skin/houdunren/assets/img/slider/slide9.jpg" width="100%" class="blog-post" alt="Feature-img" align="right" width="100%"> 
    </div>
            ...
            <div class="col-md-6">
                <div class="blockquote-box blockquote-info animated wow fadeInLeft clearfix">
                    <div class="square pull-left">
                        <img src="[!--news.url--]skin/houdunren/images/xiangjun.jpg" alt="Feature-img" height="150">
                    </div>
                    <h4>
                        向军
                    </h4>
                    <p>
                        行业经验10年以上，服务过中国石油、光大银行、丰田汽车、宝洁公司等企业。多年培训经验，讲课思路清晰，重点突出，实用性强，通俗易懂。并开发HDPHP框架与HDCMS系统
                    </p>
                </div>
                <div class="blockquote-box blockquote-primary animated wow fadeInLeft clearfix">
                    <div class="square pull-left">
                        <img src="[!--news.url--]skin/houdunren/images/sunqizheng.jpg" alt="Feature-img" height="150">
                    </div>
                    <h4>
                        孙琪峥
                    </h4>
                    <p>
                        高效率学习倡导者，接触网站行业十年，精通网站开发、策划、运营、优化，授课幽默风趣，深入浅出，通俗易懂，能准确抓住每位同学的薄弱点，因材施教，专治各种零基础，人送外号“小白杀手”。
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="blockquote-box blockquote-danger animated wow fadeInRight clearfix">
                    <div class="square pull-left">
                        <img src="[!--news.url--]skin/houdunren/images/mazhenyu.jpg" alt="Feature-img" height="150">
                    </div>
                    <h4>
                        马震宇
                    </h4>
                    <p>
                        曾担任惠普，方正，宏碁开发工程师、培训讲师，多年一线开发经验与讲师经验，讲课幽默不乏认真，轻松不乏严谨，让你的大脑时刻保持活力。擅长引导思维，而不是一味灌输，新生代优秀青年讲师的代表。
                    </p>
                </div>
                <div class="blockquote-box blockquote-warning animated wow fadeInRight clearfix">
                    <div class="square pull-left">
                        <img src="[!--news.url--]skin/houdunren/images/guli.jpg" alt="Feature-img" height="150">
                    </div>
                    <h4>
                        古丽
                    </h4>
                    <p>
                        后盾网招生咨询部主任，曾担任多家大型公司的业务客服经理，知性大方、谈吐得体，极富耐心，深受学员爱戴。凭借丰富的生活阅历和工作经验，能帮你解决报名前与学习过程中的各种琐碎问题，广受大家爱戴。
                    </p>
                </div>
            </div>
        </div>
