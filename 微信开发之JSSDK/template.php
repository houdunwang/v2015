...
<body>
    <div class="container">
        ...
        <button class="guanbi">关闭页面</button>
        <button class="xianshi">显示分享好友</button>
        <button class="yincang">隐藏非基本类按钮</button>
        <button class="xianshiall">显示全部</button>
    </div>
    <script>
        wx.config({
